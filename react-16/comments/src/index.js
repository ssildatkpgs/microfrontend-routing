...
import { ReactCommentsComponent } from './ReactCommentsComponent';

class ReactComments extends HTMLElement {
  constructor() {
    super();
  ...
  mountReactComponent() {
    const propTypes = ReactCommentsComponent.propTypes ? ReactCommentsComponent.propTypes : {};
    const props = {
    ...
    ReactDOM.render(<ReactCommentsComponent {...props} />, this);
  }
...
window.customElements.define('react-comments', ReactComments);

...
import { ReactHitsComponent } from './ReactHitsComponent';

class ReactHits extends HTMLElement {
  constructor() {
    super();
  ...
  mountReactComponent() {
    const propTypes = ReactHitsComponent.propTypes ? ReactHitsComponent.propTypes : {};
    const props = {
    ...
    ReactDOM.render(<ReactHitsComponent {...props} />, this);
  }
...
window.customElements.define('react-hits', ReactHits);
